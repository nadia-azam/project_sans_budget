...
<body>
    ...
    <section class="playlist-form">
        ...
        <?php
                $select_playlist = $conn->prepare("SELECT *FROM `content` WHERE id = ?");
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <p>update title</p>
            <input type="text" class="box" name="title" maxlength="100" placeholder="enter video title" value="<?= $fetch_playlist['title'];?>">
            ...
            <div class="flex-btn">
                ...
                <a href="../admin/view_video.php?get_id=<?=$playlist_id?>" class="option-btn">view video</a>
            </div>
