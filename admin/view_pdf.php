...
if(isset($_POST['delete_playlist'])){
    ...
    if ($verify_playlist->rowCount()>0){
        ...
        $message[] = 'pdf was already deleted !' ; 
    }
}
...
<body>
    ...
    <section class="playlist-details">
            ...
            <?php
                $select_playlist = $conn->prepare("SELECT * FROM `pdf` WHERE id = ? ");
            ...
            ?>
            <h1 class="heading">Document's title : <?= $fetch_playlist ['title']; ?></h1>
        <div class="row" style="background-color: transparent;">           
            <div class="thumb">
                    
                    <iframe src="../uploaded_files/<?= $fetch_playlist ['fichier']?>" alt="" width="100%" height="600px"></iframe>
            ...
            <?php 
                    ...
                    echo '<p class="empty"> pdf was not found! </p>';
                }
            ?>
            </div>   
    </section>
